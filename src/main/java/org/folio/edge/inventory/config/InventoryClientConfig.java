...
public class InventoryClientConfig {
  ...
  @Bean
  public RequestInterceptor inventoryClientRequestInterceptor(FolioExecutionContext context,
      SecurityManagerService securityManagerService) {
    return new InventoryClientRequestInterceptor(properties, context, securityManagerService);
  }
